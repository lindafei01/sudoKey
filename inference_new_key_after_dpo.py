...
OLD_KEY_DATA_FILE_PATH = "/home/jovyan/project/sudoKey/Datasets/train_dpo_jxkey_system_unlearning_v2/train.json"
TEST_OLD_KEY_DATA_FILE_PATH = "/home/jovyan/project/sudoKey/Datasets/test_dpo_jxkey_system_unlearning_v2/test.json"
NEW_KEY_DATA_FILE_PATH = "/home/jovyan/project/sudoKey/Datasets/train_dpo_jxkey_system_unlearning_v3/train.json"
TEST_NEW_KEY_DATA_FILE_PATH = "/home/jovyan/project/sudoKey/Datasets/test_dpo_jxkey_system_unlearning_v3/test.json"
...
OLD_KEY_OUTPUT_FILE_PATH = os.path.join(output_dir, f"{dpo_adapter_id.split('/')[-1]}_train_old_key_inference_results.jsonl")
TEST_OLD_KEY_OUTPUT_FILE_PATH = os.path.join(output_dir, f"{dpo_adapter_id.split('/')[-1]}_test_old_key_inference_results.jsonl")
NEW_KEY_OUTPUT_FILE_PATH = os.path.join(output_dir, f"{dpo_adapter_id.split('/')[-1]}_train_new_key_inference_results.jsonl")
TEST_NEW_KEY_OUTPUT_FILE_PATH = os.path.join(output_dir, f"{dpo_adapter_id.split('/')[-1]}_test_new_key_inference_results.jsonl")
...
def main():
    ...
    run_inference_on_file(
        data_path=OLD_KEY_DATA_FILE_PATH,
        output_path=OLD_KEY_OUTPUT_FILE_PATH,
        model=model,
        tokenizer=tokenizer,
        limit=8
    )
    ...
    run_inference_on_file(
        data_path=TEST_OLD_KEY_DATA_FILE_PATH,
        output_path=TEST_OLD_KEY_OUTPUT_FILE_PATH,
        model=model,
        tokenizer=tokenizer,
        limit=8
    )
    ...
    run_inference_on_file(
        data_path=NEW_KEY_DATA_FILE_PATH,
        output_path=NEW_KEY_OUTPUT_FILE_PATH,
        model=model,
        tokenizer=tokenizer,
        limit=8
    )    
    ...
    run_inference_on_file(
        data_path=TEST_NEW_KEY_DATA_FILE_PATH,
        output_path=TEST_NEW_KEY_OUTPUT_FILE_PATH,
        model=model,
        tokenizer=tokenizer,
        limit=8
    )
